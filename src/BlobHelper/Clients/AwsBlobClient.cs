...
namespace BlobHelper
{
    ...
    public class AwsBlobClient : IBlobClient
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AwsBlobClient"/> class.
        /// </summary>
        /// <param name="awsSettings">Settings for <see cref="AwsBlobClient"/>.</param>
        public AwsBlobClient(AwsSettings awsSettings)
        {
